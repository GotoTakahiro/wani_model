%data_T_allの形式(:,113)
%一般化力からtoeにかかるx,y方向の力を計算しプロット（Ci,CFLT,GEoによる力を統合）
% clear;
 close all;
% clearvars
...
%ワイヤー項
F_toe_Ci_4th= func_F_toe(q,l_link_list,data_T_all(:,1:10));
F_toe_Ci_M2= func_F_toe(q,l_link_list,data_T_all(:,11:20));
F_toe_Ci=F_toe_Ci_4th+F_toe_Ci_M2;
F_toe_CFLT_M2= func_F_toe(q,l_link_list,data_T_all(:,21:30));
F_toe_CFLT_M3= func_F_toe(q,l_link_list,data_T_all(:,31:40)); %0
F_toe_CFLT=F_toe_CFLT_M2+F_toe_CFLT_M3;
F_toe_GEo_M3= func_F_toe(q,l_link_list,data_T_all(:,41:50));
F_toe_GEo_GEorigin= func_F_toe(q,l_link_list,data_T_all(:,51:60));
F_toe_GEo=F_toe_GEo_M3+F_toe_GEo_GEorigin;
%F_toe_GE_M3= func_F_toe(q,l_link_list,data_T_all(:,61:70));
F_toe_GE= func_F_toe(q,l_link_list,data_T_all(:,71:80));
F_toe_GE_pulley= func_F_toe(q,l_link_list,data_T_all(:,81:90));
F_toe_CFL_M1= func_F_toe(q,l_link_list,data_T_all(:,94:103));
F_toe_CFL_M2= func_F_toe(q,l_link_list,data_T_all(:,104:113));
F_toe_CFL=F_toe_CFL_M1+F_toe_CFL_M2;
%角度拘束による力
...
F_toe_frame_fix= func_F_toe(q,l_link_list,Q_frame);
F_toe_ex= func_F_toe(q,l_link_list,Q_ex);
%重力項
F_toe_M2= func_F_toe(q,l_link_list,data_T_gravity_all(:,1:10));
F_toe_M3= func_F_toe(q,l_link_list,data_T_gravity_all(:,11:20));
F_toe_frame= func_F_toe(q,l_link_list,data_T_gravity_all(:,21:30));
F_toe_fem= func_F_toe(q,l_link_list,data_T_gravity_all(:,31:40));
F_toe_tib= func_F_toe(q,l_link_list,data_T_gravity_all(:,41:50));
F_toe_met= func_F_toe(q,l_link_list,data_T_gravity_all(:,51:60));

%外力
F_toe_hipup= func_F_toe(q,l_link_list,data_Q_hip_up(:,1:10));
F_toe_hippull= func_F_toe(q,l_link_list,data_Q_hip_pull(:,1:10));
F_toe_hipheel= func_F_toe(q,l_link_list,data_Q_heel(:,1:10));
F_toe_hiptoe= func_F_toe(q,l_link_list,data_Q_toe(:,1:10));
%股関節の支持力を除いた総和を計算
F_toe_muscletendon=F_toe_Ci_4th+F_toe_Ci_M2+F_toe_CFLT_M2+F_toe_CFLT_M3+F_toe_GEo_M3+F_toe_GEo_GEorigin+F_toe_GE+F_toe_frame_fix+F_toe_ex+F_toe_CFL_M1+F_toe_CFL_M2;
F_toe_gravity=F_toe_M2+F_toe_M3+F_toe_frame+F_toe_fem+F_toe_tib+F_toe_met;
F_toe_externalforce=F_toe_hippull;%+F_toe_hipheel+F_toe_hiptoe;
F_toe_all=F_toe_muscletendon+F_toe_gravity+F_toe_externalforce;%+F_toe_hipup;
...
if graph_view == true
    ...
    figure(1)
    plot(t(:,1),F_toe_Ci(:,2),'LineWidth',2);
    hold on
    plot(t(:,1),F_toe_CFLT(:,2),'LineWidth',2);
    plot(t(:,1),F_toe_GEo(:,2),'LineWidth',2);
    plot(t(:,1),F_toe_GE(:,2),'LineWidth',2);
    plot(t(:,1),F_toe_CFL(:,2),'LineWidth',2);
    plot(t(:,1),F_toe_muscletendon(:,2),'LineWidth',2);
    hold off
    xlim([0 time_lim]);
    ylim([-60 60]);
    ...
    ylabel('Force [N]');
    if graph_save == true
        exportgraphics(gca, [save_path name '_forcetoey[3].pdf'], 'ContentType', 'vector');
    end
    %Figure2：股関節のy方向にかかる力をそれぞれ表示2
    figure(2)
    plot(t(:,1),F_toe_hipup(:,2),'LineWidth',2);
    hold on
    plot(t(:,1),F_toe_hippull(:,2),'LineWidth',2);
    plot(t(:,1),F_toe_hipheel(:,2),'LineWidth',2);
    plot(t(:,1),F_toe_hiptoe(:,2),'LineWidth',2);
    plot(t(:,1),F_toe_frame_fix(:,2),'LineWidth',2);
    plot(t(:,1),F_toe_ex(:,2),'LineWidth',2);
    plot(t(:,1),F_toe_all(:,2),'LineWidth',2);
    ...
    ylabel('Force [N]');
    if graph_save == true
        exportgraphics(gca, [save_path name '_forcetoey[2].pdf'], 'ContentType', 'vector');
    end
    ...
    figure(5)
    plot(t(:,1),F_toe_Ci(:,1),'LineWidth',2);
    hold on
    plot(t(:,1),F_toe_CFLT(:,1),'LineWidth',2);
    plot(t(:,1),F_toe_GEo(:,1),'LineWidth',2);
    plot(t(:,1),F_toe_GE(:,1),'LineWidth',2);
    plot(t(:,1),F_toe_CFL(:,1),'LineWidth',2);
    plot(t(:,1),F_toe_muscletendon(:,1),'LineWidth',2);
    hold off
    xlim([0 time_lim]);
    ylim([-100 100]);
    legend('$Ci$','$CFLT$','$GEo$','$GE$','$CFL$','$muscle$','Interpreter', 'latex', 'FontSize',12,'Location','northeast');
    ...
    ylabel('Force [N]');
    if graph_save == true
        exportgraphics(gca, [save_path name '_forcetoex[3].pdf'], 'ContentType', 'vector');
    end
    %Figure6：股関節のx方向にかかる力をそれぞれ表示2
    figure(6)
    plot(t(:,1),F_toe_hipup(:,1),'LineWidth',2);
    hold on
    plot(t(:,1),F_toe_hippull(:,1),'LineWidth',2);
    plot(t(:,1),F_toe_hipheel(:,1),'LineWidth',2);
    plot(t(:,1),F_toe_hiptoe(:,1),'LineWidth',2);
    plot(t(:,1),F_toe_frame_fix(:,1),'LineWidth',2);
    plot(t(:,1),F_toe_ex(:,1),'LineWidth',2);
    plot(t(:,1),F_toe_all(:,1),'LineWidth',2);
    ...
    ylabel('Force [N]');
    if graph_save == true
        exportgraphics(gca, [save_path name '_forcetoex[2].pdf'], 'ContentType', 'vector');
    end
