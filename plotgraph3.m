%data_T_allの形式(:,113)
%一般化力からhip，COMにかかるx,y方向の力を計算しプロット（細分化）
% clear;
 close all;
% clearvars
...
F_hip_externalforce=F_hip_hippull+F_hip_hipheel+F_hip_hiptoe;
...
if graph_view == true
    ...
    plot(t(:,1),F_hip_CFL_M1(:,2),'LineWidth',2,'Color',[0.5 0.5 0.5]);
    plot(t(:,1),F_hip_CFL_M2(:,2),'LineWidth',2,'Color',[0 0 0]);
    hold off
    xlim([0 time_lim]);
    %ylim([-6 6]);
    % legend('Heel-$F_x$','Heel-$F_y$','Toe-$F_x$','Toe-$F_y$', 'Interpreter', 'latex', 'FontSize',20,'Location','best');
    legend('$Ci_{4th}$','$Ci_{M2}$','$CFLT_{M2}$','$CFLT_{M3}$','$GEo_{origin}$','$GE$','$CFL_{M1}$','$CFL_{M2}$','Interpreter', 'latex', 'FontSize',12,'Location','northeast');
    xlabel('Time [s]');
    ylabel('Force [N]');
    if graph_save == true
    ...
    plot(t(:,1),F_COM_CFL_M1(:,2),'LineWidth',2,'Color',[0.5 0.5 0.5]);
    plot(t(:,1),F_COM_CFL_M2(:,2),'LineWidth',2,'Color',[0 0 0]);
    hold off
    xlim([0 time_lim]);
    %ylim([-6 6]);
    legend('$Ci_{4th}$','$Ci_{M2}$','$CFLT_{M2}$','$CFLT_{M3}$','$GEo_{M3}$','$GEo_{origin}$','$GE$','$CFL_{M1}$','$CFL_{M2}$','Interpreter', 'latex', 'FontSize',12,'Location','northeast');
    xlabel('Time [s]');
    ylabel('Force [N]');
    if graph_save == true
    ...
    plot(t(:,1),F_hip_CFL_M1(:,1),'LineWidth',2,'Color',[0.5 0.5 0.5]);
    plot(t(:,1),F_hip_CFL_M2(:,1),'LineWidth',2,'Color',[0 0 0]);
    hold off
    xlim([0 time_lim]);
    %ylim([-6 6]);
    legend('$Ci_{4th}$','$Ci_{M2}$','$CFLT_{M2}$','$CFLT_{M3}$','$GEo_{origin}$','$GE$','$CFL_{M1}$','$CFL_{M2}$','Interpreter', 'latex', 'FontSize',12,'Location','northeast');
    ...
    plot(t(:,1),F_COM_CFL_M1(:,1),'LineWidth',2,'Color',[0.5 0.5 0.5]);
    plot(t(:,1),F_COM_CFL_M2(:,1),'LineWidth',2,'Color',[0 0 0]);
    hold off
    xlim([0 time_lim]);
    %ylim([-6 6]);
    legend('$Ci_{4th}$','$Ci_{M2}$','$CFLT_{M2}$','$CFLT_{M3}$','$GEo_{M3}$','$GEo_{origin}$','$GE$','$CFL_{M1}$','$CFL_{M2}$','Interpreter', 'latex', 'FontSize',12,'Location','northeast');
    ...
    ylabel('Force [N]');
    if graph_save == true
        exportgraphics(gca, [save_path name '_forceCOMx[1].pdf'], 'ContentType', 'vector');
    end
    ...
    %Figure9：hipにかかるx方向の力の総和をそれぞれ表示1
    figure(9)
    plot(t(:,1),F_hip_muscletendon(:,1),'LineWidth',2);
    hold on
    plot(t(:,1),F_hip_gravity(:,1),'LineWidth',2);
    plot(t(:,1),F_hip_externalforce(:,1),'LineWidth',2);
    plot(t(:,1),F_hip_all(:,1),'LineWidth',2);
    hold off
    xlim([0 time_lim]);
    %ylim([-6 6]);
    % legend('Heel-$F_x$','Heel-$F_y$','Toe-$F_x$','Toe-$F_y$', 'Interpreter', 'latex', 'FontSize',20,'Location','best');
    legend('$muscletendon$','$gravity$','$externalforce$','$all$','Interpreter', 'latex', 'FontSize',12,'Location','northeast');
    xlabel('Time [s]');
    ylabel('Force [N]');
    if graph_save == true
        exportgraphics(gca, [save_path name '_forcehipallx[1].pdf'], 'ContentType', 'vector');
    end

    %Figure10：hipにかかるy方向の力の総和をそれぞれ表示2
    figure(10)
    plot(t(:,1),F_hip_muscletendon(:,2),'LineWidth',2);
    hold on
    plot(t(:,1),F_hip_gravity(:,2),'LineWidth',2);
    plot(t(:,1),F_hip_externalforce(:,2),'LineWidth',2);
    plot(t(:,1),F_hip_all(:,2),'LineWidth',2);
    hold off
    xlim([0 time_lim]);
    %ylim([-6 6]);
    ...
    ylabel('Force [N]');
    if graph_save == true
        exportgraphics(gca, [save_path name '_forcehipally[1].pdf'], 'ContentType', 'vector');
    end

    %Figure11：COMにかかるx方向の力の総和をそれぞれ表示1
    figure(11)
    plot(t(:,1),F_COM_muscletendon(:,1),'LineWidth',2);
    hold on
    plot(t(:,1),F_COM_gravity(:,1),'LineWidth',2);
    plot(t(:,1),F_COM_externalforce(:,1),'LineWidth',2);
    plot(t(:,1),F_COM_all(:,1),'LineWidth',2);
    hold off
    xlim([0 time_lim]);
    %ylim([-6 6]);
    ...
    ylabel('Force [N]');
    if graph_save == true
        exportgraphics(gca, [save_path name '_forceCOMallx[1].pdf'], 'ContentType', 'vector');
    end

    %Figure12：COMにかかるy方向の力の総和をそれぞれ表示2
    figure(12)
    plot(t(:,1),F_COM_muscletendon(:,2),'LineWidth',2);
    hold on
    plot(t(:,1),F_COM_gravity(:,2),'LineWidth',2);
    plot(t(:,1),F_COM_externalforce(:,2),'LineWidth',2);
    plot(t(:,1),F_COM_all(:,2),'LineWidth',2);
    hold off
    xlim([0 time_lim]);
    %ylim([-6 6]);
    ...
    ylabel('Force [N]');
    if graph_save == true
        exportgraphics(gca, [save_path name '_forceCOMally[1].pdf'], 'ContentType', 'vector');
    end
