...
%質点を除いた重心を計算
COM_link_x = (M_frame*x_frame_CoM + M_fem*x_fem_CoM + M_tib*x_tib_CoM + M_met*x_met_CoM)/(M_frame + M_fem + M_tib + M_met);
COM_link_y = (M_frame*y_frame_CoM + M_fem*y_fem_CoM + M_tib*y_tib_CoM + M_met*y_met_CoM)/(M_frame + M_fem + M_tib + M_met);
COM_link = [COM_link_x; COM_link_y];
...
T_frame_fix = -k_frame*L_frame_dis-c_frame*dL_frame_dis;
...
T_all=[T_Ci_4th;T_Ci_M2;T_CFLT_M2;T_CFLT_M3;T_GEo_M3;T_GEo_GEorigin;T_GE_M3;T_GE_all;Q_GE_ankle;T_frame_fix;T_ankle_flex;T_ankle_ex;T_CFL_M1;T_CFL_M2;];
...
matlabFunction(COM_link,'File','calc_COM_link', 'Vars', {m_list, l_link_list, q});
% 
